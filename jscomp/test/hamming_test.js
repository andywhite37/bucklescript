...
function pr(param) {
  ...
  if (Caml_int64.compare(nh, n0) === 0) {
    return Curry._1(Printf.bprintf(buf, /* constructor */{
                    tag: "Format",
                    "0": /* constructor */{
                      tag: "Int64",
                      "0": "Int_d",
    ...
    return Curry._2(Printf.bprintf(buf, /* constructor */{
                    tag: "Format",
                    "0": /* constructor */{
                      tag: "Int64",
                      "0": "Int_d",
...
Mt.from_pair_suites("Hamming_test", /* constructor */{
      tag: "::",
      "0": /* tuple */[
        "output",
        (function (param) {
