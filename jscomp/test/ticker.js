...
function equal(cmp, m1, m2) {
  ...
  while(true) {
    ...
    var e1 = _e1;
    if (e1 !== "End") {
      if (e2 !== "End" && Caml_obj.caml_equal(e1[0], e2[0]) && Curry._2(cmp, e1[1], e2[1])) {
        _e2 = cons_enum(e2[2], e2[3]);
        _e1 = cons_enum(e1[2], e1[3]);
        continue ;
      } else {
                    ...
                    if (match$4 !== "[]") {
                      ...
                      if (match$5 !== "[]") {
                        ...
                        return /* tuple */[
                                /* constructor */{
                                  tag: "::",
                                  "0": make_binary_op(ticker_name, match$4[0], match$5[0], "PLUS"),
                                  "1": all_tickers
                                },
                                ticker_map
                              ];
                    ...
                    if (match$6 !== "[]") {
                      ...
                      if (match$7 !== "[]") {
                        ...
                        return /* tuple */[
                                /* constructor */{
                                  tag: "::",
                                  "0": make_binary_op(ticker_name, match$6[0], match$7[0], "MINUS"),
                                  "1": all_tickers
                                },
                                ticker_map
                              ];
