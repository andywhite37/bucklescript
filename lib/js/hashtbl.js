...
function create($staropt$star, initial_size) {
  ...
  return /* record */[
          /* size */0,
          /* data */Caml_array.caml_make_vect(s, "Empty"),
          /* seed */seed,
          /* initial_size */s
        ];
}
...
function clear(h) {
  ...
  for(var i = 0 ,i_finish = len - 1 | 0; i <= i_finish; ++i){
    Caml_array.caml_array_set(h[/* data */1], i, "Empty");
  }
  return /* () */0;
}
...
function reset(h) {
  ...
  if (h.length < 4 || len === h[/* initial_size */3]) {
    ...
    h[/* size */0] = 0;
    h[/* data */1] = Caml_array.caml_make_vect(h[/* initial_size */3], "Empty");
    return /* () */0;
  }
}
...
function resize(indexfun, h) {
  ...
  var nsize = (osize << 1);
  if (nsize >= osize) {
    var ndata = Caml_array.caml_make_vect(nsize, "Empty");
    h[/* data */1] = ndata;
    var insert_bucket = function (param) {
      if (param) {
        ...
        return Caml_array.caml_array_set(ndata, nidx, /* constructor */{
                    tag: "Cons",
                    "0": key,
                    "1": param[1],
                    "2": Caml_array.caml_array_get(ndata, nidx)
                  });
      } else {
        return "()";
      }
...
function add(h, key, info) {
  ...
  var bucket = /* constructor */{
    tag: "Cons",
    "0": key,
    "1": info,
    "2": Caml_array.caml_array_get(h[/* data */1], i)
  };
...
function replace(h, key, info) {
  ...
  try {
    ...
    if (exn === Caml_builtin_exceptions.not_found) {
      Caml_array.caml_array_set(h[/* data */1], i, /* constructor */{
            tag: "Cons",
            "0": key,
            "1": info,
            "2": l
...
function MakeSeeded(H) {
  var key_index = function (h, key) {
    return Curry._2(H.hash, h[/* seed */2], key) & (h[/* data */1].length - 1 | 0);
  };
  ...
  var find = function (h, key) {
    ...
    if (match) {
      var rest1 = match[2];
      if (Curry._2(H.equal, key, match[0])) {
        return match[1];
      } else if (rest1) {
        var rest2 = rest1[2];
        if (Curry._2(H.equal, key, rest1[0])) {
          return rest1[1];
        } else if (rest2) {
          if (Curry._2(H.equal, key, rest2[0])) {
            return rest2[1];
          } else {
            var key$1 = key;
            var _param = rest2[2];
            while(true) {
              var param = _param;
              if (param) {
                if (Curry._2(H.equal, key$1, param[0])) {
                  return param[1];
                } else {
                  _param = param[2];
                  continue ;
  ...
  var find_all = function (h, key) {
    var find_in_bucket = function (_param) {
      while(true) {
        ...
        if (param) {
          var rest = param[2];
          if (Curry._2(H.equal, param[0], key)) {
            return /* constructor */{
                    tag: "::",
                    "0": param[1],
                    "1": find_in_bucket(rest)
...
function Make(H) {
  var equal = H.equal;
  var key_index = function (h, key) {
    return Curry._1(H.hash, key) & (h[/* data */1].length - 1 | 0);
  };
  var add = function (h, key, info) {
    var i = key_index(h, key);
    var bucket = /* constructor */{
