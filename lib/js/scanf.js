...
function next_char(ib) {
  try {
    var c = Curry._1(ib[/* get_next_char */6], "()");
    ib[/* current_char */1] = c;
...
function scan_backslash_char(width, ib) {
  ...
  if (c >= 40) {
    if (c >= 58) {
      ...
      var c1$1 = get_digit$1("()");
      var c2$1 = get_digit$1("()");
    ...
    if (typeof fmt === "string") {
      ...
      switch (/* XXX */fmt.tag) {
              ...
              switch (/* XXX */rest.tag) {
                ...
                case "Formatting_gen" :
                    ...
                    if (/* XXX */match$1.tag === "Open_tag") {
                      ...
                      return pad_prec_scanf(ib, CamlinternalFormatBasics.concat_fmt(match$1[0][0], rest[1]), readers, pad, "No_precision", scan$1, token);
                    } else {
                      var scan$2 = function (width, param, ib) {
                        return scan_string(/* "[" */91, width, ib);
                      };
                      return pad_prec_scanf(ib, CamlinternalFormatBasics.concat_fmt(match$1[0][0], rest[1]), readers, pad, "No_precision", scan$2, token);
                    }
                default:
        ...
        case "Caml_string" :
            ...
            return pad_prec_scanf(ib, fmt[1], readers, fmt[0], "No_precision", scan$4, token);
        case "Int" :
