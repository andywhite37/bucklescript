  ...
  while(true) {
    ...
    if (typeof fmt === "string") {
      ...
      switch (/* XXX */fmt.tag) {
        ...
        case "Custom" :
            return make_custom(k, o, acc, fmt[2], fmt[0], Curry._1(fmt[1], "()"));
  ...
  if (typeof pad === "string") {
    ...
    return (function (x) {
        var new_acc = /* constructor */{
          tag: "Acc_data_string",
          "0": acc,
          "1": fix_padding(padty, width, Curry._1(trans, x))
        };
        return make_printf(k, o, new_acc, fmt);
      });
  } else {
    ...
    return (function (w, x) {
        var new_acc = /* constructor */{
          tag: "Acc_data_string",
          "0": acc,
          "1": fix_padding(padty$1, w, Curry._1(trans, x))
        };
        return make_printf(k, o, new_acc, fmt);
      });
  }
  ...
  while(true) {
    ...
    if (typeof acc === "string") {
      ...
      switch (/* XXX */acc.tag) {
        ...
        case "Acc_delay" :
            strput_acc(b, acc[0]);
            return $$Buffer.add_string(b, Curry._1(acc[1], "()"));
        case "Acc_flush" :
            _acc = acc[0];
            continue ;
        case "Acc_invalid_arg" :
...
function failwith_message(param) {
  ...
  return make_printf(k, "()", "End_of_acc", param[0]);
}
...
function fmt_ebb_of_string(legacy_behavior, str) {
    ...
    switch (exit$2) {
      case 7 :
          ...
          if (ign_used[0] = true, ign) {
            ...
            if (exit$3 === 9) {
              pad$3 = typeof pad === "string" ? "No_padding" : (
                  /* XXX */pad.tag === "Lit_padding" ? (
                      pad[0] >= 2 ? (
  ...
  var check_open_box = function (fmt) {
    if (typeof fmt === "string" || !(/* XXX */fmt.tag === "String_literal" && typeof fmt[1] === "string")) {
      return "()";
    } else {
      try {
