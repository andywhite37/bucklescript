...
function fmtty_of_fmt(_fmtty) {
  while(true) {
    ...
    if (typeof fmtty === "number") {
      ...
      switch (fmtty.tag | 0) {
        ...
        case /* Int */4 :
            ...
            var prec_ty = fmtty_of_precision_fmtty(fmtty[2], /* constructor */{
                  tag: 2,
                  name: "Int_ty",
                  "0": ty_rest
                });
        ...
        case /* Int32 */5 :
            ...
            var prec_ty$1 = fmtty_of_precision_fmtty(fmtty[2], /* constructor */{
                  tag: 3,
                  name: "Int32_ty",
                  "0": ty_rest$1
                });
        ...
        case /* Nativeint */6 :
            ...
            var prec_ty$2 = fmtty_of_precision_fmtty(fmtty[2], /* constructor */{
                  tag: 4,
                  name: "Nativeint_ty",
                  "0": ty_rest$2
                });
        ...
        case /* Int64 */7 :
            ...
            var prec_ty$3 = fmtty_of_precision_fmtty(fmtty[2], /* constructor */{
                  tag: 5,
                  name: "Int64_ty",
                  "0": ty_rest$3
                });
        ...
        case /* Float */8 :
            ...
            var prec_ty$4 = fmtty_of_precision_fmtty(fmtty[2], /* constructor */{
                  tag: 6,
                  name: "Float_ty",
                  "0": ty_rest$4
                });
    ...
    return fmtty_of_padding_fmtty(fmtty[0], /* constructor */{
                tag: 1,
                name: "String_ty",
                "0": fmtty_of_fmt(fmtty[1])
              });
      ...
      switch (fmt.tag | 0) {
        ...
        case /* Caml_char */1 :
            ...
            return function (c) {
              var new_acc = /* constructor */{
                tag: 4,
                name: "Acc_data_string",
                "0": acc,
                "1": format_caml_char(c)
              };
        ...
        case /* Scan_get_counter */21 :
            ...
            return function (n) {
              var new_acc = /* constructor */{
                ...
                name: "Acc_data_string",
                "0": acc,
                "1": Caml_format.caml_format_int("%u", n)
              };
  ...
  if (typeof pad === "number") {
    ...
    return (function (w, x) {
        var new_acc = /* constructor */{
          ...
          name: "Acc_data_string",
          "0": acc,
          "1": fix_padding(padty, w, Curry._1(trans, x))
        };
        return make_printf(k, o, new_acc, fmt);
      });
  } else {
    ...
    return (function (x) {
        var new_acc = /* constructor */{
          ...
          name: "Acc_data_string",
          "0": acc,
          "1": fix_padding(padty$1, width, Curry._1(trans, x))
        };
        return make_printf(k, o, new_acc, fmt);
      });
  }
      ...
      if (size !== 1) {
        ...
        return /* constructor */{
                ...
                "0": /* constructor */{
                  tag: 12,
                  name: "Char_literal",
                  "0": Caml_string.get(str, lit_start),
                  "1": fmt
                }
              };
      }
