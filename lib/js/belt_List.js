...
function splitAux(_cell, _precX, _precY) {
  while(true) {
    ...
    if (cell) {
      var match = cell[0];
      var nextA = /* constructor */{
        tag: "::",
        "0": match[0],
        "1": "[]"
      };
      var nextB = /* constructor */{
        tag: "::",
        "0": match[1],
        "1": "[]"
      };
...
function partitionU(l, p) {
  if (l) {
    var h = l[0];
    var nextX = /* constructor */{
      tag: "::",
      "0": h,
      "1": "[]"
    };
    var nextY = /* constructor */{
      tag: "::",
      "0": h,
      "1": "[]"
    };
...
function unzip(xs) {
  if (xs) {
    var match = xs[0];
    var cellX = /* constructor */{
      tag: "::",
      "0": match[0],
      "1": "[]"
    };
    var cellY = /* constructor */{
      tag: "::",
      "0": match[1],
      "1": "[]"
    };
