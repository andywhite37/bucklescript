...
var env = /* record */[
  ...
  /* v_stack */Caml_array.caml_make_vect(100, "()"),
...
function grow_stacks(param) {
  ...
  var new_v = Caml_array.caml_make_vect(newsize, "()");
...
function clear_parser(param) {
  $$Array.fill(env[/* v_stack */1], 0, env[/* stacksize */4], "()");
  env[/* lval */7] = "()";
  return /* () */0;
}
    ...
    if (exn$1[0] === YYexit) {
      ...
      current_lookahead_fun[0] = (function (tok) {
          if (typeof tok !== "number") {
            return Caml_array.caml_array_get(tables[/* transl_block */2], /* XXX */tok.tag) === curr_char;
          } else {
...
function symbol_start(param) {
  return symbol_start_pos("()")[/* pos_cnum */3];
}

function symbol_end(param) {
  return symbol_end_pos("()")[/* pos_cnum */3];
}
