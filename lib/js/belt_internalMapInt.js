...
function cmpU(s1, s2, cmp) {
  ...
  if (len1 === len2) {
    return compareAux(Belt_internalAVLtree.stackAllLeft(s1, "[]"), Belt_internalAVLtree.stackAllLeft(s2, "[]"), cmp);
  } else if (len1 < len2) {
    return -1;
  } else {
    return 1;
...
function eqU(s1, s2, eq) {
  ...
  var len2 = Belt_internalAVLtree.size(s2);
  if (len1 === len2) {
    return eqAux(Belt_internalAVLtree.stackAllLeft(s1, "[]"), Belt_internalAVLtree.stackAllLeft(s2, "[]"), eq);
  } else {
    return false;
  }
}
