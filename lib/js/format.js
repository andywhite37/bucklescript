...
function break_new_line(state, offset, width) {
  Curry._1(state[/* pp_out_newline */18], "()");
...
function pp_force_break_line(state) {
  ...
  if (match) {
    ...
    return Curry._1(state[/* pp_out_newline */18], "()");
  }
}
...
function pp_print_newline(state, param) {
  ...
  return Curry._1(state[/* pp_out_flush */17], "()");
}
      ...
      case "Acc_delay" :
          ...
          if (typeof p$7 !== "string" && /* XXX */p$7.tag === "Acc_formatting_lit") {
            ...
            if (typeof match$6 !== "string" && /* XXX */match$6.tag === "Magic_size") {
              ...
              return pp_print_as_size(ppf, match$6[1], Curry._1(acc[1], "()"));
            }
            
          }
          strput_acc(ppf, p$7);
          return pp_print_string(ppf, Curry._1(acc[1], "()"));
      case "Acc_flush" :
          strput_acc(ppf, acc[0]);
          return pp_print_flush(ppf, "()");
      case "Acc_invalid_arg" :
...
function ksprintf(k, param) {
  ...
  return CamlinternalFormat.make_printf(k$prime, "()", "End_of_acc", param[0]);
}
...
function asprintf(param) {
  ...
  return CamlinternalFormat.make_printf(k$prime, ppf, "End_of_acc", param[0]);
}
...
function bprintf(b, param) {
  ...
  return CamlinternalFormat.make_printf(k, formatter_of_buffer(b), "End_of_acc", param[0]);
}
