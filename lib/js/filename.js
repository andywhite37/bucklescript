...
function temp_file_name(temp_dir, prefix, suffix) {
  ...
  return concat(temp_dir, Curry._3(Printf.sprintf(/* constructor */{
                      tag: "Format",
                      "0": /* constructor */{
                        tag: "String",
                        "0": "No_padding",
...
function temp_file($staropt$star, prefix, suffix) {
  ...
  while(true) {
    ...
    try {
      Caml_external_polyfill.resolve("caml_sys_close")(Caml_external_polyfill.resolve("caml_sys_open")(name, /* constructor */{
                tag: "::",
                "0": "Open_wronly",
                "1": /* constructor */{
                  tag: "::",
...
function open_temp_file($staropt$star, $staropt$star$1, prefix, suffix) {
  var mode = $staropt$star !== undefined ? $staropt$star : /* constructor */({
        tag: "::",
        "0": "Open_text",
        "1": "[]"
      });
  ...
  while(true) {
    ...
    try {
      return /* tuple */[
              name,
              Pervasives.open_out_gen(/* constructor */{
                    tag: "::",
                    "0": "Open_wronly",
                    "1": /* constructor */{
                      tag: "::",
